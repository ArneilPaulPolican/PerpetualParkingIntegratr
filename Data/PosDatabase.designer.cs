...
namespace PerpetualIntegrator.Data
{
    ...
    partial void DeleteTrnStockOut(TrnStockOut instance);
		...
		public PosDatabaseDataContext() : 
				base(global::PerpetualIntegrator.Properties.Settings.Default.pos13ConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnParkingIdChanging(string value);
    partial void OnParkingIdChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ParkingId", DbType="NVarChar(50)")]
